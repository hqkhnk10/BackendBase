...
namespace APIWithDapperTutorial.Data.Context
{
    public class SchoolContext
    {
        ...
        public IDbConnection CreateConnection() => new SqlConnection(connectionStringOptions.MySqlConnection);
        public string GetConnection() => connectionStringOptions.MySqlConnection;
    }
}
